...
export async function handlerChirpsRetrieve(req: Request, res: Response) {
    ...
    filteredChirps.sort((a,b) =>
      sortDirection === "asc" ? a.createdAt.getTime() - b.createdAt.getTime() : b.createdAt.getTime() - a.createdAt.getTime()
    );
...
export async function handlerChirpsGet(req: Request, res: Response) {
    ...
    if(!chirp) {
        throw new NotFoundError(`Chirp with chirpId: ${chirpId} is not found`);
    }
